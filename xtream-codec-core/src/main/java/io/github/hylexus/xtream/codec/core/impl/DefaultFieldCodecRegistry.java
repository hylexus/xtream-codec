...
public class DefaultFieldCodecRegistry implements FieldCodecRegistry {
    ...
    static void init(DefaultFieldCodecRegistry registry) {
        ...
        registry.register(DataFieldCodecs.INSTANCE, DataField.I8.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.U8.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.I16.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.U16.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.I32.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.U32.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.I64.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.F32.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.F64.class, -1, "", false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.GbkString.class, -1, XtreamConstants.CHARSET_NAME_GBK, false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.Utf8String.class, -1, XtreamConstants.CHARSET_NAME_UTF8, false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.Gb2312String.class, -1, XtreamConstants.CHARSET_NAME_GB_2312, false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.Bcd8421String.class, -1, XtreamConstants.CHARSET_NAME_BCD_8421, false);
        registry.register(DataFieldCodecs.INSTANCE, DataField.Struct.class, -1, "", false);
