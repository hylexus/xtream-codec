...
call .\gradlew.bat clean build publishMavenPublicationToPrivateRepository publishMavenBomPublicationToPrivateRepository ^
 -Dorg.gradle.parallel=false ^
 -Pxtream.maven.repo.private.enabled=true ^
