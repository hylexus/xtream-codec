    ...
    @Preset.JtStyle.SimpleMap(
            ...
            value = @Value(
                    encoder = @ValueEncoder(
                            ...
                            matchers = {
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x01, valueType = XtreamDataType.u32, desc = "里程，DWORD，1/10km，对应车上里程表读数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x02, valueType = XtreamDataType.u16, desc = "油量，WORD，1/10L，对应车上油量表读数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x03, valueType = XtreamDataType.u16, desc = "行驶记录功能获取的速度，WORD，1/10km/h"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x04, valueType = XtreamDataType.u16, desc = "需要人工确认报警事件的 ID，WORD，从 1 开始计数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x11, valueType = XtreamDataType.byte_array, desc = "长度1或5；超速报警附加信息见 表 28"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x25, valueType = XtreamDataType.u32, desc = "扩展车辆信号状态位，定义见 表 31"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x30, valueType = XtreamDataType.u8, desc = "数据类型为 BYTE，无线通信网络信号强度"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x31, valueType = XtreamDataType.u8, desc = "数据类型为 BYTE，GNSS 定位卫星数"),
                    ...
                    decoder = @ValueDecoder(
                            ...
                            matchers = {
                                    ...
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x25, valueType = XtreamDataType.u32, desc = "扩展车辆信号状态位，定义见 表 31"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x30, valueType = XtreamDataType.u8, desc = "数据类型为 BYTE，无线通信网络信号强度"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x31, valueType = XtreamDataType.u8, desc = "数据类型为 BYTE，GNSS定位卫星数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x64, valueEntity = LocationItem0x64.class, desc = "苏标: 高级驾驶辅助报警信息，定义见表 4-15"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x65, valueEntity = LocationItem0x65.class, desc = "苏标: 驾驶员状态监测系统报警信息，定义见表 4-17"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x66, valueEntity = LocationItem0x66.class, desc = "苏标: 胎压监测系统报警信息，定义见表 4-18"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x67, valueEntity = LocationItem0x67.class, desc = "苏标: 盲区监测系统报警信息，定义见表 4-20"),
