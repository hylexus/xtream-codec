...
class JtStyleDebugEntity01NestedSimpleTest extends BaseEntityCodecTest {
    @BeforeEach
    void setUp() {
    ...
    @Test
    void test() {
        final JtStyleDebugEntity01NestedSimple originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);

        final JtStyleDebugEntity01NestedSimple entity = this.doDecode(JtStyleDebugEntity01NestedSimple.class, hexString);
    ...
    JtStyleDebugEntity01NestedSimple createEntity() {
        final JtStyleDebugEntity01NestedSimple entity = new JtStyleDebugEntity01NestedSimple();
        final JtStyleDebugEntity01NestedSimple.Body body = new JtStyleDebugEntity01NestedSimple.Body();
        final JtStyleDebugEntity01NestedSimple.Header header = new JtStyleDebugEntity01NestedSimple.Header();
