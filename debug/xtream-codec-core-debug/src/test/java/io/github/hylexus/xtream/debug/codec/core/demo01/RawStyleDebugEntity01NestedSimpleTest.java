...
class RawStyleDebugEntity01NestedSimpleTest extends BaseEntityCodecTest {
    @BeforeEach
    void setUp() {
    ...
    @Test
    void test() {
        final RawStyleDebugEntity01NestedSimple originalEntity = this.createEntity();
        final String hexString = this.encodeAsHexString(originalEntity);

        final RawStyleDebugEntity01NestedSimple entity = this.doDecode(RawStyleDebugEntity01NestedSimple.class, hexString);
    ...
    RawStyleDebugEntity01NestedSimple createEntity() {
        final RawStyleDebugEntity01NestedSimple entity = new RawStyleDebugEntity01NestedSimple();
        final RawStyleDebugEntity01NestedSimple.Body body = new RawStyleDebugEntity01NestedSimple.Body();
        final RawStyleDebugEntity01NestedSimple.Header header = new RawStyleDebugEntity01NestedSimple.Header();
