import{_ as p}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as c,o as u,c as r,b as n,d as s,e as o,w as a}from"./app-y0t8QcnO.js";const k={},d=n("h1",{id:"扁平化写法示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#扁平化写法示例"},[n("span",null,"扁平化写法示例")])],-1),m={class:"hint-container tip"},v=n("p",{class:"hint-container-title"},"提示",-1),b=n("li",null,[s("所谓的 "),n("em",null,"扁平化写法"),s(" 就是不用单独封装 "),n("code",null,"Header"),s(" 和 "),n("code",null,"Body"),s("，而是直接将 "),n("code",null,"Header"),s(" 和 "),n("code",null,"Body"),s(" 的数据写在同一个实体类中")],-1),y=n("h2",{id:"解码",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#解码"},[n("span",null,"解码")])],-1),g=n("h3",{id:"实体类定义",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#实体类定义"},[n("span",null,"实体类定义")])],-1),h=n("div",{class:"language-java line-numbers-mode","data-ext":"java","data-title":"java"},[n("pre",{class:"language-java"},[n("code",null,[n("span",{class:"token annotation punctuation"},"@Setter"),s(`
