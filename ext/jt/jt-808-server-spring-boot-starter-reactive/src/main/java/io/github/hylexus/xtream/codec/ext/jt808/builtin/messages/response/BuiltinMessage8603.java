...
public class BuiltinMessage8603 {
    ...
    public BuiltinMessage8603 setAreaCount(short areaCount) {
    ...
    public BuiltinMessage8603 setAreaIdList(List<DwordWrapper> areaIdList) {
    ...
    public String toString() {
        return new StringJoiner(", ", BuiltinMessage8603.class.getSimpleName() + "[", "]")
