...
public class BuiltinMessage8300 {
    ...
    public BuiltinMessage8300 setIdentifier(short identifier) {
    ...
    public BuiltinMessage8300 setText(String text) {
        this.text = text;
        return this;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", BuiltinMessage8300.class.getSimpleName() + "[", "]")
