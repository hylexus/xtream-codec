    ...
    @Preset.JtStyle.SimpleMap(
            ...
            value = @Value(
                    ...
                    encoder = @ValueEncoder(
                            ...
                            matchers = {
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x01, valueType = u32, desc = "里程，DWORD，1/10km，对应车上里程表读数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x02, valueType = u16, desc = "油量，WORD，1/10L，对应车上油量表读数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x03, valueType = u16, desc = "行驶记录功能获取的速度，WORD，1/10km/h"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x04, valueType = u16, desc = "需要人工确认报警事件的 ID，WORD，从 1 始计数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x05, valueType = byte_array, desc = "胎压"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x06, valueType = i16_as_int, desc = "车厢温度"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x11, valueEntity = Item0x11.class, desc = "长度1或5；超速报警附加信息见 表 28"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x25, valueType = u32, desc = "扩展车辆信号状态位，定义见 表 31"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x2A, valueType = u16, desc = "IO 状态位，表 32"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x2B, valueType = i32, desc = "模拟量，bit0-15,AD0,bit16-31,AD1"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x30, valueType = u8, desc = "数据类型为 BYTE，无线通信网络信号强度"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x31, valueType = u8, desc = "数据类型为 BYTE，GNSS定位卫星数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x64, valueEntity = LocationItem0x64.class, desc = "苏标: 高级驾驶辅助报警信息，定义见表 4-15"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x65, valueEntity = LocationItem0x65.class, desc = "苏标: 驾驶员状态监测系统报警信息，定义见表 4-17"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x66, valueEntity = LocationItem0x66.class, desc = "苏标: 胎压监测系统报警信息，定义见表 4-18"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x67, valueEntity = LocationItem0x67.class, desc = "苏标: 盲区监测系统报警信息，定义见表 4-20"),
                            }
                    ),
                    decoder = @ValueDecoder(
                            ...
                            matchers = {
                                    ...
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x02, valueType = u16, desc = "油量，WORD，1/10L，对应车上油量表读数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x03, valueType = u16, desc = "行驶记录功能获取的速度，WORD，1/10km/h"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x04, valueType = u16, desc = "需要人工确认报警事件的 ID，WORD，从 1 开始计数"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x05, valueType = byte_array, desc = "胎压"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x06, valueType = i16_as_int, desc = "车厢温度"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x11, valueEntity = Item0x11.class, desc = "长度1或5；超速报警附加信息见 表 28"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x12, valueEntity = Item0x12.class, desc = "进出区域/路线报警附加信息消息"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x13, valueEntity = Item0x13.class, desc = "路线行驶时间不足/过长报警附加信息"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x25, valueType = u32, desc = "扩展车辆信号状态位，定义见 表 31"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x2A, valueType = u16, desc = "IO 状态位，表 32"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x2B, valueType = i32, desc = "模拟量，bit0-15,AD0,bit16-31,AD1"),
                                    @XtreamMapField.ValueMatcher(matchU8 = 0x30, valueType = u8, desc = "数据类型为 BYTE，无线通信网络信号强度"),
