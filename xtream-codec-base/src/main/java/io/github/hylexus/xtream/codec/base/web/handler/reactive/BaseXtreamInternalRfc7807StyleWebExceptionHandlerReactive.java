 ...
 */
public class BaseXtreamInternalRfc7807StyleWebExceptionHandlerReactive {
    private static final Logger log = LoggerFactory.getLogger(BaseXtreamInternalRfc7807StyleWebExceptionHandlerReactive.class);

    public BaseXtreamInternalRfc7807StyleWebExceptionHandlerReactive() {
    }
    ...
    private static Mono<ResponseEntity<?>> render(XtreamApiProblemDetails problemDetails) {
        final ResponseEntity<XtreamApiProblemDetails> responseEntity = problemDetails.toResponseEntity();
        return Mono.just(responseEntity);
    }

    private static Mono<ResponseEntity<?>> render(int httpStatus, Object body) {
        final ResponseEntity<Object> responseEntity = ResponseEntity
                .status(httpStatus)
